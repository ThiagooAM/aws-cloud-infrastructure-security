...
What you built: IAM least-privilege users/roles, a VPC with public/private subnets, an EC2 web server behind a NAT gateway, encrypted S3, RDS/DynamoDB databases, KMS key management.
